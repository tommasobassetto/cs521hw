...
(define-fun f ((x Real)) Real
    (f5 x) ; replace with whatever function you're using
)


(define-fun Tf_lower ((l Real) (u Real)) Real
0.0 ; insert the lower bound generated by sygus. replace a with l and b with u.
)

(define-fun Tf_upper ((l Real) (u Real)) Real
(max (f l) (f u)) ; insert the upper bound generated by sygus. replace a with l and b with u.
)
